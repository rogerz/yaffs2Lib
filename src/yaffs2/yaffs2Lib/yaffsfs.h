...
extern yaffs_Object *yaffsfs_FindObject(yaffs_Object *relativeDirectory, const YCHAR *path, int symDepth);
extern yaffs_Object *yaffsfs_FindDirectory(yaffs_Object *relativeDirectory,const YCHAR *path,YCHAR **name,int symDepth);
extern yaffs_Object *yaffsfs_GetHandleObject(int handle);
extern yaffsfs_Handle *yaffsfs_GetHandlePointer(int h);
